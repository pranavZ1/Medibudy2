                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm">
                        {formatCurrency(treatment.pricing.minPrice)} - {formatCurrency(treatment.pricing.maxPrice)}
                      </span>
                    </div>

                    <div className="flex items-center space-x-2">
                      <Clock className="h-4 w-4 text-blue-500" />
                      <span className="text-sm text-gray-600">{treatment.duration.procedure}</span>
                    </div>
                    ...
                    {treatment.ageGroup && (
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Ages {treatment.ageGroup.min}-{treatment.ageGroup.max}</p>
                      </div>
                    )}
                    ...
                    {treatment.risks && treatment.risks.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {treatment.risks.slice(0, 2).map((risk: string, index: number) => (
                            <span key={index} className="text-xs bg-red-100 text-red-700 px-2 py-1 rounded">
                              {risk}
                            </span>
                          ))}
                          {treatment.risks.length > 2 && (
                            <span className="text-xs text-gray-500">
                              +{treatment.risks.length - 2} more
                            </span>
                          )}
                        </div>
                      </div>
